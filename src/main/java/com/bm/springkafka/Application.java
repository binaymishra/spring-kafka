 ...
 * @author Binay Mishra
 * <p>
 * Step-1 C:\apache-zookeeper-3.7.0\bin>zkServer Step-2 C:\kafka_2.12-2.8.0>.\bin\windows\kafka-server-start.bat
 * .\config\server.properties Step-3 kafka-topics.bat --create --zookeeper localhost:2181
 * --replication-factor 1 --partitions 1 --topic topic-1
 */
